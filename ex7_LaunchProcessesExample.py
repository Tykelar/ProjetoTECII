...
def work(Run):
	...
	os.system("python3 ex7_read_project_files.py AmberTarget_Run_"+str(Run)+".root")
...
os.system("rm finalResults7.root")
os.system("hadd finalResults7.root results7_*.root")
